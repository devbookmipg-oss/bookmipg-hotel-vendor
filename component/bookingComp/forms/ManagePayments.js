...
const PAYMENT_MODES = ['Cash', 'Card', 'UPI', 'Net Banking', 'Wallet'];
        ...
        >
          <Table size="small">
            <TableHead sx={{ bgcolor: 'primary.light' }}>
              <TableRow>
                {['Date', 'Mode', 'Amount (₹)', 'Remark', 'Actions'].map(
                  (header) => (
                    <TableCell
                      key={header}
                  ...
                  >
                    <TableCell>
                      <TextField
                        ...
                        value={payment.date}
                        onChange={(e) =>
                          handleInlineChange(index, 'date', e.target.value)
                        }
                        fullWidth
                      />
                    </TableCell>
