...
const DobReportPrint = React.forwardRef((props, ref) => {
          ...
          <TableBody>
            ...
            {filteredData?.map((row, index) => (
              <TableRow key={index}>
                ...
                <BodyCell>{GetCustomDate(row.dob)}</BodyCell>
...
DobReportPrint.displayName = 'DobReportPrint'; // 👈 required

export { DobReportPrint };
